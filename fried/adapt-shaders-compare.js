...
function buildShaders () {
  ...
  void main (void) {
    ...
    float kz = 0.8 * (zFocalDistance + zFieldWidth) / zFieldWidth;
    float kw = 0.8 * (wFocalDistance + wFieldWidth) / wFieldWidth;

    float fz = kz * abs(depth - zFocalDistance) / depth;
    float fw = kw * abs(w - wFocalDistance) / w;
